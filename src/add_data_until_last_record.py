...
mysql_data_manager.insert_into_table("serie", leagues_df)
mysql_data_manager.insert_into_table("match", leagues_df)
mysql_data_manager.insert_into_table("tournament", leagues_df)
mysql_data_manager.insert_into_table("match_game", leagues_df)
mysql_data_manager.insert_into_table("match_opponent", leagues_df)
mysql_data_manager.insert_into_table("match_stream", leagues_df)
