...
def generate_data_representations(matches_infos_dataframe):
    dataframe_home_team = matches_infos_dataframe.rename({"away_id": "opponent_id"}, axis=1)
    dataframe_away_team = matches_infos_dataframe.rename({"home_id": "opponent_id"}, axis=1)
