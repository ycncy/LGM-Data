...
async def main():
    ...
    tasks = [mysql_data_manager.insert_or_update_data_async(dataframes['match_game'], 'match_game'), mysql_data_manager.insert_or_update_data_async(dataframes['match_opponent'], 'match_opponent'),
             mysql_data_manager.insert_or_update_data_async(dataframes['match_stream'], 'match_stream')]
